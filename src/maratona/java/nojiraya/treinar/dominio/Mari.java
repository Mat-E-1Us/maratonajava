...
public class Mari extends Personagem{
    public final double BONUS_DE_DANO = 0.2;
    public final double BONUS_DE_SORTE = 0.02;
    private static String vazio = "Branco";

    public Mari(String nome, int idade, double peso, double altura, Locale nacionalidade, double dano, int sorte, Habilidade habilidade, Mundo mundo, double money) {
